  ...
  return (
    <div className="relative bg-primary overflow-hidden scroll-smooth">
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-[400vh] md:top-[240vh] -left-40 w-[400px] h-[400px] md:w-[700px] md:h-[700px] rounded-full bg-secondary/60 blur-[160px]" />
        <div className=" absolute top-[490vh] md:top-[280vh] lg:top-[350vh] -right-40 w-[400px] h-[400px] md:w-[700px] md:h-[700px] rounded-full bg-secondary/60 blur-[160px]" />
      </div>
